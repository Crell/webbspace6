<?php
// $Id: example.drushrc.php,v 1.31 2010/02/23 18:10:36 greg1anderson Exp $
...
#  );
$options['site-aliases']['stage'] = array(
    'uri' => 'www.garfieldtech.com/webbspace',
    'root' => '/usr/home/lgarfiel/public_html/garfieldtech/webbspace',
    'db-url' => 'mysql://lgarfiel_18:26YF2sV2@db137e.pair.com/lgarfiel_webbspacedev',
    'remote-host' => 'www.garfieldtech.com',
    'remote-user' => 'lgarfiel',
#    'path-aliases' => array(
#      '%drush' => '/path/to/drush',
#      '%drush-script' => '/path/to/drush/drush',
#      '%dump' => '/path/to/live/sql_dump.sql',
...
$options['site-aliases']['dev'] = array(
    'uri' => 'localhost/~lgarfiel/projects/webbspace/branches/drupal6v2',
    'root' => '/home/lgarfiel/public_html/projects/webbspace/branches/drupal6v2',
  );
